...
export async function getRepoData() {
  const res = await fetch(
    "https://api.github.com/repos/navigateui/navigateui",
...
export default async function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-[99] h-[50px] w-full bg-white shadow-[0px_0px_.7px]">
      <div className="item-center mx-auto flex h-full max-w-con justify-between px-2 py-2 lg:px-10">
        ...
        <Link
          href="/"
          className="group hidden items-center gap-px rounded-lg text-xl font-semibold lg:flex"
        >
          <Image
            src="/Logo.svg"
            className="size-8"
        ...
        <ul className="flex items-center gap-2 text-2xl">
          ...
          <li>
            <Link
              ...
              href="https://github.com/NavigateUI/nui.animated"
              target="_blank"
            >
              {/* <div className="flex items-center justify-center gap-[2px] rounded-md bg-black/90 px-1 py-[2px] text-xs font-black text-white">
                <FaStar />
                <span className="font-mono">
                  {data?.stargazers_count || 142}
                </span>
              </div> */}
          ...
          <li>
            <Link
              ...
              href="https://discord.com/invite/ezphnpnEXx"
              target="_blank"
            >
          ...
          <li>
            <Link
              className="group relative flex items-center justify-center"
              href="https://www.facebook.com/groups/navigateui/"
              target="_blank"
            >
