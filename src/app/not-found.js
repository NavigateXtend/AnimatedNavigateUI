...
export default function NotFound() {
  return (
    <div className="flex h-[70vh] w-full select-none flex-col items-center justify-center text-center font-mono">
      ...
      <h1 className="z-0 text-9xl leading-[100px] text-sky-400 blur-sm sm:text-[200px] md:text-[260px] lg:text-[300px] xl:text-[400px]">
        404
      </h1>
      ...
      <div className="z-10 text-white">
        <Link
          href="/"
          className="m-2 flex items-center justify-center gap-2 rounded-lg bg-sky-500 px-6 py-2.5 text-lg"
        >
          <FiHome /> Navigate to Home
        </Link>
        <Link
